      ...
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        <div className="w-1/5">
          <a href="/" className="flex items-center">
            <img
              src="https://user-images.githubusercontent.com/78534043/223768806-c3083ef9-8d6b-4f55-b859-1a62d263f0da.png"
              ...
              {!isLoggedin ? (
                <>
                  ...
                  <li>
                    <a
                      href="/register"
                      className="inline-flex items-center justify-center p-0.5 mr-1 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800"
                    >
                ...
                <>
                  ...
                  <li>
                    <a type="button" className="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2 text-center" href="/new">
                      Create Codex +
                    </a>
                  </li>
                  <li>
