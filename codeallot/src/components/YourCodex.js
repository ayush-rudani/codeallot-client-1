...
function YourCodex() {
    ...
    async function fetchCodexByUserid() {
        ...
        if (user.id != null) {
            getCodexByUserid(user.id).then((res) => {
                console.log(res);
                if (res.status === 200) {
                    setCodex(res.data);
                    setLoading(false);
                ...
                <div className="w-3/12">
                    <div className="w-full max-w-sm mx-auto mt-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="flex flex-col items-center pb-10 space-y-3">
                            <img className="w-24 h-24 mb-3 rounded-full shadow-lg" src="https://api.dicebear.com/5.x/initials/svg?seed=A" alt="" />
                            ...
                            <div className="container block text-center">
                                ...
                                <a href="#" className=" text-blue-600 dark:text-blue-500 hover:underline">link</a>
                            </div>
