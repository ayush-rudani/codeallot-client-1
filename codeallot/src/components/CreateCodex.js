...
function CreateCodex() {
    ...
    const handleSubmit = (e) => {
        ...
        if (user.id != null) {
            ...
            newCodex(user.id, value.title, value.description, value.filename, code).then((res) => {
                // console.log(res);
                if (res.status === 200) {
    ...
    return (
        <>
            ...
            <div className="w-8/12 rounded-xl mx-auto mt-5 mb-5">
                <input value={value.title} onChange={handleInputs} name="title" type="text" className="w-5/12 p-2 mb-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Codex Title" />

                <input value={value.description} onChange={handleInputs} name="description" type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Codex Description" />
